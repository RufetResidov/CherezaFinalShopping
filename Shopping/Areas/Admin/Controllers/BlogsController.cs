...
namespace Shopping.Areas.Admin.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        public BlogsController(EcommerceContext context, IWebHostEnvironment environment)
        {
            _context = context;
        ...
        {
            var ecommerceContext = _context.Blogs.Include(b => b.BlogCategory);
        ...
        public async Task<IActionResult> Create([Bind("Header,Title,PublishDate,PhotoUrl,BlogCategoryID,ID,ModifiedOn")] Blog blog,IFormFile PhotoUrl)
        {
            ...
            ViewData["BlogCategoryID"] = new SelectList(_context.BlogCategory, "ID", "Name", blog.BlogCategoryID);
            return View(blog);
        }
