...
namespace Shopping.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "Mövcud şifrə boş buraxıla bilməz")]
            [DataType(DataType.Password)]
            [Display(Name = "Current password")]
            public string OldPassword { get; set; }

            [Required(ErrorMessage = "Yeni şifrə boş buraxıla bilməz")]
            ...
            [Compare("NewPassword", ErrorMessage = "Şifrə və şifrə təkrarı eyni olmalidir..")]
